...
version(/+$DIDE_REGION+/all) {
	...
	class AMDBCore {
		/+
			/+
				Assistant: /+
					Para: This is a D language implementation of an /+Bold: Associative Memory Database (AMDB)+/ system. Here's
					a comprehensive summary:
				+/
				
				/+H2: Core Architecture+/
				
				/+Bold: AMDBCore+/ is the main database engine that manages:
					/+Bullet: /+Bold: Items+/: Named entities stored as strings with unique IDs+/
					/+Bullet: /+Bold: Links+/: Triplet associations (source-verb-target) representing relationships+/
					/+Bullet: /+Bold: Transactions+/: ACID-compliant operations with commit/cancel support+/
				
				/+H2: Key Components+/
				
				/+H3: Data Structures+/
					/+Bullet: /+Bold: Id+/: Unique identifier struct with serialization/deserialization+/
					/+Bullet: /+Bold: Link+/: Source-Verb-Target triplets forming the association graph+/
					/+Bullet: /+Bold: Items/Links+/: Dual-indexed containers (ID→data and data→ID)+/
				
				/+H3: Storage Interfaces+/
					/+Bullet: /+Bold: DBFileInterface+/: Abstract file operations+/
					/+Bullet: /+Bold: TextDBFile+/: Plain text file implementation+/
					/+Bullet: /+Bold: ArchiverDBFile+/: Archive-based storage+/
				
				/+H2: Core Features+/
				
				/+H3: Data Model+/
					/+Bullet: /+Bold: Schema definitions+/: Entity types (EType), verbs, association types (AType)+/
					/+Bullet: /+Bold: Data entries+/: Entity instances and their relationships+/
					/+Bullet: /+Bold: System types+/: Built-in types (String, Int, DateTime, etc.)+/
					/+Bullet: /+Bold: System verbs+/: Core relationships like "is a"+/
				
				/+H3: Query System+/
					/+Bullet: /+Bold: Wildcard matching+/ with pattern syntax+/
					/+Bullet: /+Bold: Multi-sentence queries+/ for complex relationship traversal+/
					/+Bullet: /+Bold: Source-based queries+/ for graph navigation+/
					/+Bullet: /+Bold: Left/right extensions+/ for context expansion+/
				
				/+H3: Transaction Management+/
					/+Bullet: /+Bold: Buffered operations+/ with commit/cancel support+/
					/+Bullet: /+Bold: Referential integrity+/ checks+/
					/+Bullet: /+Bold: Atomic operations+/ with rollback capability+/
				
				/+H2: Advanced Capabilities+/
				
				/+H3: Text Processing+/
					/+Bullet: /+Bold: Natural language parsing+/ for schema and data input+/
					/+Bullet: /+Bold: Sentence-based syntax+/ using double-space separators+/
					/+Bullet: /+Bold: Quoted string handling+/ with escape sequences+/
					/+Bullet: /+Bold: Continuation markers+/ ("...") for multi-line relationships+/
				
				/+H3: Visualization+/
					/+Bullet: /+Bold: Pretty-printing+/ with color-coded output+/
					/+Bullet: /+Bold: Table formatting+/ with automatic column alignment+/
					/+Bullet: /+Bold: Graph traversal+/ for relationship display+/
				
				/+H3: Type System+/
					/+Bullet: /+Bold: Dynamic type creation+/ with validation+/
					/+Bullet: /+Bold: Inheritance checking+/ via "is a" relationships+/
					/+Bullet: /+Bold: Type constraints+/ for data validation+/
				
				/+H2: Usage Patterns+/
				
				The system supports:
					/+Bullet: /+Bold: Interactive command-line interface+/ with commands like:+/
						/+Bullet: /+Highlighted: schema+///+Highlighted: data+/ for input+/
						/+Bullet: /+Highlighted: query+/ for searching+/
						/+Bullet: /+Highlighted: commit+///+Highlighted: cancel+/ for transactions+/
					/+Bullet: /+Bold: Programmatic API+/ for application integration+/
					/+Bullet: /+Bold: Bulk operations+/ for data import/export+/
				
				/+
					Para: This is essentially a graph database with a natural language interface, designed for managing
					complex relationship networks with strong typing and transactional integrity.
				+/
				
				/+Note: Usage(prompt_hit: 0, prompt_miss: 20355, completion: 556, HUF: 2.32, price: 100%)+/
			+/
			/+User: Make a quick reference too!+/
			/+
				Assistant: /+
					Structured: /+ AMDB Quick Reference +/
					
					/+ Core Commands +/
					schema "Entity  is a  EType"		// Define entity types
					data "John  is a  Person"	    //	Create entity instances
					query "Person"		// Search database
					commit				 // Save	changes
					...
					/+ Sentence Format +/
					"source  verb  target"			// Basic triplet
					"..."		         // Continue from	previous
					"Entity  is a  EType"			// Type definition
					"verb  is a  Verb"		         //	Verb definition
					
					/+ System Types +/
					String, Int, Long, UInt, ULong, Float, Double, DateTime, Date, Time
					
					/+ System Verbs +/
					"is a"                          // Type/instance relationship
					
					/+ Command Line Interface +/
					id <number>	                // Show item/link by ID
					items [mask]	                // List all items
					...
					auto db = new AMDBCore(archiver, "db"); // Load from archive
					
					/+ Transaction Pattern +/
					db.data("John	 is a	Person"); 
					db.data("John	 works	at  ACME"); 
					if(valid) db.commit(); else db.cancel(); 
...
version(/+$DIDE_REGION+/all) {
	...
	version(/+$DIDE_REGION Data Building Blocks+/all)
	{
		private
		{
			...
			public/+Todo: amdb uses is. Make it accessible!+/ struct SortedAssocArray(K, V)
			{
