...
class DebugLogServer{
	...
	void tryCreate() {
		dataFile = CreateFileMappingW(	INVALID_HANDLE_VALUE,	 // use paging file
	...
	ubyte[] CircBuf_getLog(ref uint tail, ref uint head, in uint cap, ubyte* buf){ //reads a packet from the circbuff
