...
auto exceptionCodeToStr(uint code){
	...
	enum names = [	"ACCESS_VIOLATION"	, "DATATYPE_MISALIGNMENT"	, "BREAKPOINT"	, "SINGLE_STEP"	, "ARRAY_BOUNDS_EXCEEDED"	,
		...
		"FLT_STACK_CHECK"	, "FLT_UNDERFLOW"	, "INT_DIVIDE_BY_ZERO"	, "INT_OVERFLOW"	, "PRIV_INSTRUCTION"	,
		"IN_PAGE_ERROR"	, "ILLEGAL_INSTRUCTION"	, "NONCONTINUABLE_EXCEPTION"	, "STACK_OVERFLOW"	, "INVALID_DISPOSITION"	,
		"GUARD_PAGE"	, "INVALID_HANDLE"				];
	switch(code){
...
{
	static immutable wchar[2][] ALPHA_TABLE =  //todo: discover these chars. Decide if they are useful or not.
	[
		[0x00AA, 0x00AA],
		[0x00B5, 0x00B5],
		[0x00B7, 0x00B7],
